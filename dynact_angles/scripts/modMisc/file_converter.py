...
def fileConverter(input_img, output_img) :
    ...
    if os.path.isdir(input_img) :
        ...
        elif os.path.isfile(input_img) and ('.nii' or '.mha' or '.mhd' or '.raw' or '.nrrd' in in_ext.lower()) :
...
if __name__ == '__main__' :
    ...
    parser.add_argument('output_img', type=str, help='The output image (path + filename)')
