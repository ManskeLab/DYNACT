...
if __name__ == '__main__' :
    ...
    parser.add_argument("input_path", type=str, help="The input DICOM directory (compressed files)")
    ...
    l = len([name for name in os.listdir(input_path_abs) if os.path.isfile(os.path.join(input_path_abs, name))])
